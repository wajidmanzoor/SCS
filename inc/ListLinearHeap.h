...
class ListLinearHeap {
 ...
 public:
  ...
  // get the (id,key) pair with the maximum key value; return true if success,
  ...
  // pop the (id,key) pair with the maximum key value; return true if success,
  // return false otherwise
  ...
  // get the (id,key) pair with the minimum key value; return true if success,
  // return false otherwise
  ...
  // pop the (id,key) pair with the minimum key value; return true if success,
  // return false otherwise
